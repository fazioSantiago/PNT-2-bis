...
namespace TPDetailing2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //roles si no existen los creo aca
            ...
            await _emailStore.SetUserNameAsync(user, usuario, CancellationToken.None);
